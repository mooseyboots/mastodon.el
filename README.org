...
Opens a =*mastodon-home*= buffer so you can see toots. There's no major mode yet, so there are
no keybindings or actions to take from this buffer. Coming soon!
